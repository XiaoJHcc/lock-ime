...
点击托盘图标弹出浮窗即可调整所有设置（开关、下拉、阈值），浮窗不可用的旧系统回退为原生菜单 + 设置窗口。


## 运行

直接双击 `lock-ime.exe`，托盘出现 🀄 图标即在运行。点击托盘图标打开设置浮窗。
...
| `src/tray.rs` | 托盘图标与回退原生菜单 |
| `src/flyout.rs` | WinUI 3 设置浮窗（四卡片：中文/日文/CapsLock/自启） |
